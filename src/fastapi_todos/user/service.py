...
class UserService(domain.UserServiceBase):
    def send_email(
        self,
        email_to: str,
    ...
    def send_new_account_email(
        ...
        #     template_str = f.read()
        template_str = self._get_template("new_account.html")
    ...
    def send_reset_password_email(self, email_to: str, email: str, token: str) -> None:
        ...
        #     template_str = f.read()
        template_str = self._get_template("reset_password.html")
    ...
    def send_test_email(self, email_to: str) -> None:
        ...
        #     template_str = f.read()
        template_str = self._get_template("test_email.html")
        self.send_email(
            email_to=email_to,
            subject_template=subject,
            html_template=template_str,
